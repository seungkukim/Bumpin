...
public class AccountPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retrofit = new Retrofit.Builder()
                ...
                .baseUrl(userAccountService.API_URL).build();
        loginService = retrofit.create(userAccountService.class);
